...
<head>
    ...
    <title>Tambah Data Materi - Critani </title>
    <!-- General CSS Files -->
...
?></div>
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <div class="dropdown-title">Admin - Critani</div>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="nav-item dropdown ">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="<?=base_url('admin/data_user')?>">Data User</a></li>
                            </ul>
                        </li>
                        <li class="menu-header">Management Mitra</li>
                        <li class="nav-item dropdown">
                            <a href="#" class="nav-link has-dropdown"><i class="fas fa-chalkboard-teacher"></i>
                                <span>Mitra</span></a>
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="<?=base_url('admin/data_mitra')?>">Data Mitra</a>
                                </li>
                                <li><a class="nav-link" href="<?=base_url('admin/add_mitra')?>">Tambah Data Mitra</a>
                                </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="nav-link" href="<?=base_url('admin/about_critani')?>">Tentang
                                        Critani</a>
                                </li>
                            </ul>
                        </li>
                    ...
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                ...
                                <hr>
                                <p class="card-text"> Penambahan data materi dapat dilakukan oleh admin dan mitra yang
                            ...
                            <div id="detail" class="card-body">
                                <form method="POST" enctype="multipart/form-data"
                                    ...
                                    <div class="col-md-12 bg-white"
                                        ...
                                        <form method="post" enctype="multipart/form-data"
                                            action="<?=base_url('mitra/add_materi')?>">
                                            <input type="hidden" name="id">
                                            <div class="form-row">
                                                <div class="form-group col-md-12">
                                                    <label for="inputEmail4">Nama mitra</label>
                                                    <input autocomplete="off" required type="text" list="nama_mitra"
                                                        onkeyup="autofill()" id="namamitra" name="nama_mitra"
                                                        class="form-control">
                                                    <small>List mitra sudah tersedia di autocomplete, kalian hanya
                                                        tinggal klik input area nya atau dengan cara menulis namanya dan
                                                        klik mitra yang akan dipilih.</small>
                                                    <datalist id=nama_mitra>
                                                        <?php
include "koneksi.php";
$qry = mysqli_query($koneksi, "SELECT nama_mitra From mitra");
while ($t = mysqli_fetch_array($qry)) {
    echo "<option value='$t[nama_mitra]'>";
}
?>
                                                    </datalist>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="nama_cerita"
                                                    id="nama_cerita" required
                                                    placeholder="Pilih nama mitra yang valid agar nama cerita muncul"
                                                    readonly>
                                                <small>Jika nama cerita sudah berganti artinya nama mitra yang kamu
                                                    masukan di input area adalah valid! jika tidak muncul nama cerita
                                                    anda harus klik input area nama mitra dan pilih mitra yang tersedia
                                                    disana.</small>
                                            </div>
                                            <div class="form-group">
        ...
        function autofill() {
            ...
            $.ajax({
                ...
                var json = data,
                    obj = JSON.parse(json);
                $('#nama_cerita').val(obj.nama_cerita);
            });
        }
        </script>
        <script>
