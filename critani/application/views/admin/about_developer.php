                ...
                <section class="section">
                    <div class="">
                        <div class="hero text-white hero-bg-image"
                            ...
                            <div class="col-md-4 mx-auto rounded-circle bg-white p-3"
                                ...
                                <img src="<?=base_url('assets/')?>chizuru.jpg"
                    ...
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                <h2 class="card-title" style="color: black;">Tentang One Octadion</h2>
                                <hr>
                                <p class="card-text">One Octadion merupakan programmmer yang membuat project
                                Critani ini. Kalian dapat menghubungi dengan kontak atau URL yang telah saya taruh
                                    dibawah. </p>
