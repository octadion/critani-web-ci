...
<head>
    ...
    <title>Tentang Developer - Critani</title>
    <!-- General CSS Files -->
            ...
            <div class="main-content">
                <section class="section">
                    <div class="section-header">
                        <h1 style="font-size: 27px; letter-spacing:-0.5px; color:black;">Tentang Project Critani </h1>
                    </div>
                    <div class="">
                        <video class="afterglow" autoplay id="myvideo" width="1280" height="720">
                            <source type="video/mp4" src="<?=base_url('assets/')?>CRITANI.mp4" />
                        </video>
                    </div>
                    <br>
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                <h2 class="card-title" style="color: black;">Tentang Critani</h2>
                                <hr>
                                <p class="card-text">SWeb Edukasi Open Source yang dibuat oleh One Octadion . 
                                    Critani adalah Web edukasi tradisi lisan yang dilengkapi video, materi, dan soal (
                                    Coming soon ) yang didesign semenarik dan sesimple mungkin. Critani dibuat
                                    ditujukan agar para user dan mitra dapat terus belajar dan mengajar dimana saja dan
                                    kapan saja. </p>
                    ...
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                ...
                                <hr>
                                <a href="" class="btn btn-primary">Web Portofolio</a>
                                <a href="" style="background-color:pink; color:white;"
                                ...
                                <a style="background-color:purple; color:white;"
                                    href="https://www.instagram.com/octadion/" class="btn">Instagram</a>
                                <a href="https://web.facebook.com/dyon.octa/"
                                    style="background-color:blue; color:white;" class="btn ">Facebook</a>
                                <a href="https://github.com/octadion" style="background-color:black; color:white;"
                                    class="btn">Github</a>
                                <a href="" style="background-color:black; color:white;"
                                    class="btn">Medium</a>
                            </div>
                        </div>
                    </div>
