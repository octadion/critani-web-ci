...
<head>
    ...
    <title>Data Detail User - Critani </title>
    <!-- General CSS Files -->
                    ...
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                ...
                                <hr>
                                <p class="card-text"> Detail User meliputi Nama, Photo, E-mail, Akun aktif, dan Date
                                    Created.
                        ...
                        <div class="col-md-12 bg-white p-3" id="detail"
                            ...
                            <a href="<?=base_url('admin/data_User')?>" class="btn btn-success btn-block">Kembali</a>
                        </div>
                    </div>
                </section>
            </div>
