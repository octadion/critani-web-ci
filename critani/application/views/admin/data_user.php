                ...
                <section class="section">
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                <h2 class="card-title" style="color: black;">Management Data User Critani</h2>
                                <hr>
                                <p class="card-text"> Jumlah User yang terdaftar di Critani sekarang adalah <span
                                        class="font-weight-bold" style="color:black;">
                                        <?php echo $this->db->count_all('user'); ?> user.</span> Perlu diperhatikan,
                                    User yang terdaftar namun tidak mengaktivasi email nya dalam kurun 24 jam setelah
    ...
    ?>
                                            <tr class="text-center">
                                                ...
                                                <td class="text-center">
                                                    <a href="<?php echo site_url('admin/detail_User/' . $u->id); ?>"
                                                        class="btn btn-success">Detail</a>
                                                </td>

                                                <td class="text-center">
                                                    <a href="<?php echo site_url('admin/update_User/' . $u->id); ?>"
