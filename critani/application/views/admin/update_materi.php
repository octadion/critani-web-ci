...
<head>
    ...
    <title>Update Data Materi - Critani</title>
    <!-- General CSS Files -->
                    ...
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                ...
                                <hr>
                                <p class="card-text"> Update data materi meliputi Nama Mitra, Nama cerita dan Deskripsi
                                    Materi.
                        ...
                        <div class="card-body">
                            <form method="POST" action="<?=base_url('admin/materi_edit')?>">
                                ...
                                <div class="form-group">
                                    <label for="nip">Nama Mitra</label>
                                    <input readonly id="nama_mitra" type="text" class="form-control"
                                        value="<?=$u->nama_mitra?>" name="nama_mitra">
                                    <?=form_error('nama_mitra', '<small class="text-danger">', '</small>');?>
                                    <div class="invalid-feedback">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="nama_cerita">Cerita</label>
                                    <input readonly id="nama_cerita" type="text" value="<?=$u->nama_cerita?>"
                                        class="form-control" name="nama_cerita">
