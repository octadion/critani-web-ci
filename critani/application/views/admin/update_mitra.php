...
<head>
    ...
    <title>Update Data Mitra - Critani</title>
    <!-- General CSS Files -->
                ...
                <section class="section">
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                <h2 class="card-title" style="color: black;">Update Data Mitra</h2>
                                <hr>
                                <p class="card-text"> Update data user meliputi Email dan Nama Lengkap.
                                    Kita tidak bisa mengubah password mitra, Hanya mitra yang dapat mengubah passwordnya
                                    sendiri.
                                </p>
                    ...
                    <div class="card card-success">
                        ...
                        <div class="card-body">
                            <form method="POST" action="<?=base_url('admin/mitra_edit')?>">
                                ...
                                <div class="form-group" id="detail">
                                    ...
                                    <input id="nama" type="text" value="<?=$u->nama_mitra?>" class="form-control"
                                        name="nama">
