...
<head>
    ...
    <title>Admin Dashboard - Critani</title>
    <!-- General CSS Files -->
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                            <div class="card card-statistic-1">
                                ...
                                <div class="card-wrap">
                                    ...
                                    <div class="card-body">
                                        <?php echo $this->db->count_all('mitra'); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                ...
                                <p class="card-text">Klik tombol dibawah untuk menambah materi . Materi yang
                                    ditambahkan, akan langsung terupload di database Critani. Dan para user bisa
                                    segera belajar! </p>
...
echo $data['user']['username'];
?>!</h1>
                                <p class="lead">Di halaman admin Critani - Web Cerita Tradisi Lisan Indonesia
                                    <br></p>
                                <div class="mt-4">
            ...
            <footer class="main-footer">
                <div class="footer-left">
                    Copyright &copy; 2020 <div class="bullet"></div> Code & Design by <a
                        href="https://github.com/">octadion</a>
                </div>
