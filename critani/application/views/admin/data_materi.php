...
<head>
    ...
    <title>Data Materi - Critani</title>
                ...
                <section class="section">
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                <h2 class="card-title" style="color: black;">Management Data Materi Critani</h2>
                                <hr>
                                <p class="card-text"> Jumlah Materi yang terdata di Critani sekarang adalah <span
                                        class="font-weight-bold" style="color:black;">
                                        <?php echo $this->db->count_all('materi'); ?> Materi.</span> Materi dapat
                                    ditambah oleh mitra maupun admin, materi meliputi video, deskripsi dan soal. </p>
