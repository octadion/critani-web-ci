...
<head>
    ...
    <title>Data Mitra - Critani</title>
                ...
                <section class="section">
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                <h2 class="card-title" style="color: black;">Management Data Mitra critani</h2>
                                <hr>
                                <p class="card-text"> Jumlah Mitra yang terdaftar di Learnify sekarang adalah <span
                                        class="font-weight-bold" style="color:black;">
                                        <?php echo $this->db->count_all('mitra'); ?> Mitra.</span> Untuk sementara, Mitra
                                    tidak dapat melakukan pendaftaran online sendiri. Hanya admin yang diperkenankan
                                    untuk mendaftarkan Mitra. </p>
                                <a href="<?=base_url('admin/add_mitra')?>" class="btn btn-primary">Tambah
                                    Data Mitra</a>
                            </div>
                        </div>
                    </div>
    ...
    ?>
                                        <tr class="text-center">
                                            ...
                                            <td class="text-center">
                                                <a href="<?php echo site_url('admin/detail_mitra/' . $u->nip); ?>"
                                                    class="btn btn-success">Detail</a>
                                            </td>

                                            <td class="text-center">
                                                <a href="<?php echo site_url('admin/update_mitra/' . $u->nip); ?>"
                                                    class="btn btn-info">Update</a>

                                                <a href="<?php echo site_url('admin/delete_mitra/' . $u->nip); ?>"
...
?>
                                ...
                                <p class="small font-weight-bold">Pendaftaran mitra hanya dapat dilakukan admin.jika mitra
    ...
    Swal.fire({
        icon: 'success',
        title: 'Data Mitra Telah Dirubah!',
    ...
    Swal.fire({
        icon: 'success',
        title: 'Data Mitra Telah Dihapus!',
