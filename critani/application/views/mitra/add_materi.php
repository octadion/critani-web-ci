...
<head>
    <meta charset="utf-8" />
    <title>Critani - Tambah Materi</title>
    ...
    <div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed ">
        <div class="kt-header-mobile__logo">
            <a href="<?=base_url('mitra')?>">
                <img alt="Logo" src="<?=base_url('assets')?>/img/logocrit.png" width="90px;" />
            </a>
        </div>
                    ...
                    <div id="kt_aside_menu" class="kt-aside-menu  kt-aside-menu--dropdown " data-ktmenu-vertical="1"
                        ...
                        <ul class="kt-menu__nav ">
                            <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true"><a
                                    href="<?=base_url('mitra')?>" class="kt-menu__link"><i
                                ...
                                <form method="post" enctype="multipart/form-data"
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <input required type="text" readonly name="nama_mitra" value="<?php
$data['user'] = $this->db->get_where('mitra', ['email' =>
    $this->session->userdata('email')])->row_array();
echo $data['user']['nama_mitra'];?>" class="form-control" id="inputEmail4">
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            <label for="inputEmail4">Nama Cerita</label>
...
echo $data['user']['nama_mapel'];?>" class="form-control" id="inputEmail4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select required id="inputState" name="kelas" class="form-control">
                                            ...
                                            <option value="Nyanyian">Nyanyian</option>
                                        </select>
                                    </div>
                ...
                <div class="kt-footer kt-grid__item kt-grid kt-grid--desktop kt-grid--ver-desktop">
                    ...
                    <div class="kt-footer__menu">
                        Made with &nbsp; <span class="" style="color: red"> &#10084;</span> &nbsp; by octadion
                    </div>
                </div>
