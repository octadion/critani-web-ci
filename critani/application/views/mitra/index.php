...
<head>
    ...
    <!--end::Layout Skins -->
    <link rel="shortcut icon" href="<?=base_url('assets')?>/img/iconn.png" />
...
<body
    ...
    <div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed ">
        <div class="kt-header-mobile__logo">
            <a href="<?=base_url('mitra/add_materi')?>">
                ...
                <div class="kt-aside__brand kt-grid__item " id="kt_aside_brand">
                    <div class="kt-aside__brand-logo">
                        <a href="<?=base_url('mitra')?>">
                            <img alt="Logo" width="35px;" src="<?=base_url('assets')?>/img/iconn.png" />
                        </a>
                    </div>
                </div>
                    ...
                    <div id="kt_aside_menu" class="kt-aside-menu  kt-aside-menu--dropdown " data-ktmenu-vertical="1"
                        ...
                        <ul class="kt-menu__nav ">
                            <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--submenu-fullheight kt-menu__item--open kt-menu__item--here"
                                aria-haspopup="true"><a href="<?=base_url('mitra')?>" class="kt-menu__link"><i
                                ...
                                <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                                    <ul class="kt-menu__subnav">
                                        ...
                                        <li class="kt-menu__item " aria-haspopup="true"><a
                                                href="<?=base_url('mitra/add_materi')?>" class="kt-menu__link "><i
                        ...
                        <div id="kt_header_menu" class="kt-header-menu kt-header-menu-mobile  kt-header-menu--layout- ">
                            <ul class="kt-menu__nav ">
                                <li class="kt-menu__item  kt-menu__item--active " aria-haspopup="true"><a
                                        href="<?=base_url('mitra')?>" class="kt-menu__link "><span
                            ...
                            <div
                                ...
                                <div class="kt-user-card kt-user-card--skin-light kt-notification-item-padding-x">
                                    ...
                                    <div class="kt-user-card__name font-weight-bold">
                                        Hai!, &nbsp;<?php
$data['user'] = $this->db->get_where('mitra', ['email' =>
    $this->session->userdata('email')])->row_array();
echo $data['user']['nama_mitra'];
?>
                                    </div>
                                </div>
                                ...
                                <div class="kt-notification">
                                    <a href="<?=base_url('mitra/add_materi')?>" class="kt-notification__item">
                                ...
                                <div class="kt-portlet kt-portlet--height-fluid kt-widget19">
                                    <div class="kt-portlet__body kt-portlet__body--fit">
                                        <div class="kt-widget19__pic kt-portlet-fit--top kt-portlet-fit--sides">
                                            <img src="<?=base_url('assets/')?>img/mitr.png" class=" img-fluid" alt=""
                                                srcset="">
...
?> !
                                            ...
                                            <div class="kt-widget19__labels">
                                                <a href="#" class="btn btn-label-light-o2 btn-bold btn-sm ">Critani</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="kt-portlet__body">
                                        <div class="kt-widget19__wrapper">
                                            ...
                                            <div class="kt-widget19__text">
                                                Selamat datang di halaman mitra Critani, anda dapat menambah materi .
                                                Dalam materi anda dapat memasukan video, dan deskripsi nya. Seemoga anda
                                                dapat menikmati Critani!, kontak Administrator jika terjadi masalah
                        ...
                        <div class="kt-footer kt-grid__item kt-grid kt-grid--desktop kt-grid--ver-desktop">
                            <div class="kt-footer__copyright">
                                2020&nbsp;&copy;&nbsp;<a href="https://github.com/octadion" target="_blank"
                                    class="kt-link">octadion</a>
                            </div>
