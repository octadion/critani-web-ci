...
<head>
    ...
    <link rel="icon" href="<?=base_url('assets/')?>img/iconn.png" type="image/png">
    <!-- Title -->
    <title>Cerita Rakyat - <?php
            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                <div class="container">
                    ...
                    <a class="navbar-brand logo_h" href="<?=base_url('welcome')?>"><img
                            src="<?=base_url('assets/')?>img/logocrit.png" alt=""></a>
            ...
            <div class="row" style="color: black; font-family: 'poppins';">
                <div class="col-md-12 mt-1">
                    <h1 class="display-4" style="color: black; font-family:'poppins';" data-aos="fade-down"
                        data-aos-duration="1400">Silahkan pilih cerita !
                    </h1>
                    <p>Hello pegiat budaya! , Ini merupakan halaman Critani ! Silahkan pilih cerita yang akan kamu
                        akses
                        .Selamat belajar ya students!</p>
                    <hr>
...
?> - Critani User</h3>
    ...
    <div class="container">
        <div class="row mt-4 mb-5">
            <div class="col-md-4 mb-2 d-flex justify-content-center" data-aos-duration="1900" data-aos="fade-right">
                <a href="<?=base_url('materi/kiandongsari')?>">
                    <div class="card-kelas">
                        <img src="<?=base_url('assets/')?>img/kiandong.png" class="card-img-top" alt="...">
                    </div>
                </a>
            </div>
            <div class="col-md-4 mb-2 d-flex justify-content-center" data-aos-duration="1900" data-aos="fade-down">
                <a href="<?=base_url('materi/walikidangan')?>">
                    <div class="card-kelas">
                        <img src="<?=base_url('assets/')?>img/walikid.png" class="card-img-top" alt="...">
                    </div>
                </a>
            </div>
            <div class="col-md-4 mb-2 d-flex justify-content-center" data-aos-duration="1900" data-aos="fade-left">
                <a href="<?=base_url('materi/buayaputihbengawansolo')?>">
                    <div class="card-kelas">
                        <img src="<?=base_url('assets/')?>img/buaya.png" class="card-img-top" alt="...">
                    </div>
                </a>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row mt-4 mb-5">
            <div class="col-md-4 mb-2 d-flex justify-content-center" data-aos-duration="1900" data-aos="fade-right">
                <a href="<?=base_url('materi/radenlancingkusumo')?>">
                    <div class="card-kelas">
                        <img src="<?=base_url('assets/')?>img/raden.png" class="card-img-top" alt="...">
                    </div>
                </a>
            </div>
            <div class="col-md-4 mb-2 d-flex justify-content-center" data-aos-duration="1900" data-aos="fade-down">
                <a href="<?=base_url('materi/roro')?>">
                    <div class="card-kelas">
                        <img src="<?=base_url('assets/')?>img/roro.png" class="card-img-top" alt="...">
                    </div>
                </a>
            </div>
            <div class="col-md-4 mb-2 d-flex justify-content-center" data-aos-duration="1900" data-aos="fade-left">
