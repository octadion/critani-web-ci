...
<head>
    ...
    <title>Critani - Bercerita Menginspirasi Negeri</title>
    <!-- Bootstrap CSS -->
        ...
        <div class="top_menu row m0">
            <div class="container">
                ...
                <div class="float-right">
                    ...
                    <a class="dn_btn" href="mailto:support@colorlib.com">critaniproject2020@gmail.com</a>
                </div>
            </div>
        </div>
        <div class="main_menu">
                    ...
                    <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                        <ul class="nav navbar-nav menu_nav ml-auto">
                            ...
                            <li class="nav-item submenu dropdown">
                                <a href="<?=base_url('welcome/critani')?>" class="nav-link dropdown-toggle"
                                    role="button" aria-haspopup="true" aria-expanded="false">Critani</a>
                                <ul class="dropdown-menu">
                                    <li class="nav-item"><a class="nav-link" href="courses.html">Sejarah</a>
                                    <li class="nav-item"><a class="nav-link" href="course-details.html">Cerita Rakyat</a></li>
                                    <li class="nav-item"><a class="nav-link" href="courses.html">Legenda</a>
                                    <li class="nav-item"><a class="nav-link" href="course-details.html">Mitos</a></li>
                                    <li class="nav-item"><a class="nav-link" href="courses.html">Budaya</a>
                                </ul>
                            </li>
