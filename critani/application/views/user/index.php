            ...
            <div class="row" style="color: black; font-family: 'poppins';">
                <div class="col-md-12 mt-1">
                    <h1 class="display-4" style="color: black; font-family:'poppins';" data-aos="fade-down"
                        ...
                        di Critani <span style="font-size: 40px;">👋🏻
                        </span> </h1>
                    <p>Hello Pegiat Budaya , Ini merupakan halaman utama Critani! Silahkan pilih cerita yang akan kamu
                        akses
                        .Selamat belajar ya!</p>
                    <hr>
...
echo $data['user']['nama'];
?> - Critani User</h3>
                        <p data-aos="fade-down" data-aos-duration="1800">Silahkan pilih cerita yang akan kamu akses
                            dibawah
                            ini!
                        </p>
                </div>
            ...
            <div class="col-md-12">
                <div class="row">
                    <div class="col-sm-4 mb-2 d-flex justify-content-center " data-aos-duration="1900"
                        data-aos="fade-right">
                        <a href="<?=base_url('user/ceritarakyat')?>">
                            <div class="card-kelas text-center">
                                <img src="<?=base_url('assets/')?>img/ceritarakyat.png" style="object-fit: cover;"
                    ...
                    <div class="col-sm-4 mb-2 d-flex justify-content-center " data-aos-duration="1900"
                        data-aos="fade-down">
                        <a href="<?=base_url('user/legenda')?>">
                            <div class="card-kelas">
                                <img src="<?=base_url('assets/')?>img/legenda.png" class="card-img-top" alt="...">
                            </div>
                        </a>
                    </div>
                    <div class="col-sm-4 mb-2 d-flex justify-content-center" data-aos-duration="1900"
                        data-aos="fade-left">
                        <a href="<?=base_url('user/nyanyian')?>">
                            <div class="card-kelas">
                                <img src="<?=base_url('assets/')?>img/nyanyian.png" class="card-img-top" alt="...">
                            </div>
                        </a>
                    </div>
                </div>
