    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-2  col-md-6 col-sm-6">
                <div class="single-footer-widget tp_widgets">
                    ...
                    <ul class="list">
                        <li><a href="<?=base_url('welcome/tentang')?>">Tentang Critani</a></li>
                        <li><a href="<?=base_url('welcome/materi')?>">Materi Critani</a></li>
                        <li><a href="<?=base_url('welcome/kontak')?>">Kontak Critani</a></li>
                        <li><a href="http://smkn1ciamis.id/">Website Resmi Mitra</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-2  col-md-6 col-sm-6">
                <div class="single-footer-widget tp_widgets">
                    ...
                    <ul class="list">
                        ...
                        <li><a href="<?=base_url('welcome/guru')?>">Untuk Mitra</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-2  col-md-6 col-sm-6">
                <div class="single-footer-widget tp_widgets">
                    <h6 class="footer_title">Koleksi</h6>
                    <ul class="list">
                        <li><a href="javaScript:void(0);">Cerita Rakyat</a></li>
                        <li><a href="javaScript:void(0);">Legenda</a></li>
                        <li><a href="javaScript:void(0);">Mitos</a></li>
            ...
            <div class="col-lg-2  col-md-6 col-sm-6">
                <div class="single-footer-widget tp_widgets">
                    ...
                    <ul class="list">
                        <li><a href="https://github.com/octadion">octadion</a></li>
                        <li><a href="#">yube</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6">
                <h4 class="footer_title">Tentang Critani</h4>
                <p>
                    Critani adalah website untuk Mencari
                     dan berbagi sebuah data mengenai tradisi lisan yang sudah melalui proses 
                     validasi oleh dinas terkait (Dinas Kebudayaan dan Pariwisata)
                </p>
            </div>
        </div>
        <div class="row footer-bottom d-flex justify-content-between align-items-center">
            ...
            <div class="col-lg-4 col-md-4 footer-social">
                <a href="https://www.facebook.com/critani"><i class="fa fa-facebook"></i></a>
                <a href="https://twitter.com/heathcliffexe"><i class="fa fa-twitter"></i></a>
                <a href="https://dribbble.com/octadion"><i class="fa fa-dribbble"></i></a>
                <a href="https://www.behance.net/octadion"><i class="fa fa-behance"></i></a>
            </div>
        </div>
    </div>
</footer>
