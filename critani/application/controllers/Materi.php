...
class Materi extends CI_Controller
{
    ...
    {
        $this->load->model('m_materi');
        $data['materi'] = $this->m_materi->kiandongsari()->result();
        $data['user'] = $this->db->get_where('user', ['email' =>
            $this->session->userdata('email')])->row_array();
        $this->load->view('materi/kiandongsari', $data);
    ...
    {
        $this->load->model('m_materi');
        $data['materi'] = $this->m_materi->walikidangan()->result();
        $data['user'] = $this->db->get_where('user', ['email' =>
            $this->session->userdata('email')])->row_array();
        $this->load->view('materi/walikidangan', $data);
        $this->load->view('template/footer');
    }
    ...
    {
        $this->load->model('m_materi');
        $data['materi'] = $this->m_materi->radenlancingkusumo()->result();
        $data['user'] = $this->db->get_where('user', ['email' =>
            $this->session->userdata('email')])->row_array();
        $this->load->view('materi/radenlancingkusumo', $data);
        $this->load->view('template/footer');
    }
    ...
    {
        $this->load->model('m_materi');
        $data['materi'] = $this->m_materi->buayaputihbengawansolo()->result();
        $data['user'] = $this->db->get_where('user', ['email' =>
            $this->session->userdata('email')])->row_array();
        $this->load->view('materi/buayaputihbengawansolo', $data);
        $this->load->view('template/footer');
    }
    ...
    {
        $this->load->model('m_materi');
        $data['materi'] = $this->m_materi->roro()->result();
        $data['user'] = $this->db->get_where('user', ['email' =>
            $this->session->userdata('email')])->row_array();
        $this->load->view('materi/roro', $data);
        $this->load->view('template/footer');
    }
