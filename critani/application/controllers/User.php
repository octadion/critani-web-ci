...
class User extends CI_Controller
{
    ...
    public function ceritarakyat()
    {
        ...
        $this->load->view('user/ceritarakyat');
        $this->load->view('template/footer');
    }
    ...
    public function legenda()
    {
        ...
        $this->load->view('user/legenda');
        $this->load->view('template/footer');
    }

    public function nyanyian()
    {
        $data['user'] = $this->db->get_where('user', ['email' =>
            $this->session->userdata('email')])->row_array();

        $this->load->view('user/nyanyian');
        $this->load->view('template/footer');
    }
    ...
    private function _sendEmail($token, $type)
    {
        ...
        $this->email->from('critaniproject2020@gmail.com', 'critani');
